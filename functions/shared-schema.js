...
(function () {
  ...
  const VIBES = [
    ...
    { id: 'royal', label: 'Royal', desc: 'Dark · cosmos stars', category: 'dark',
    ...
    { id: 'neon', label: 'Neon', desc: 'Dark · circuit pulse', category: 'dark',
    ...
    /* —— Bold & experimental —— */
    { id: 'synthwave', label: 'Synthwave', desc: 'Bold · pink waves + violet aurora', category: 'bold',
      cos: { theme: 'dark', accent: '#9333ea', type: 'modern', headingFont: 'display', tracking: 'wide', cursorStyle: 'trail', cursorColor: '#f472b6', scanlines: false, bgPattern: 'waves', wallpaperBrightness: 62, wallpaperIntensity: 54, wallpaperAnimSpeed: 50, waveDirection: 'diagonal-up', wallpaperUseAccent: false, wallpaperColor: '#ec4899', wallpaper2: { enabled: true, bgPattern: 'aurora', wallpaperBrightness: 48, wallpaperIntensity: 40, wallpaperAnimSpeed: 42, wallpaperUseAccent: false, wallpaperColor: '#7c3aed' }, cursorEffect: 'trail', cursorEffectTrailStyle: 'glow', cursorEffectTrailLength: 58, cursorEffectIntensity: 65, vignetteIntensity: 40, vignetteDirection: 'center', glow: 160, radius: 'round', vibe: 'synthwave' } },
    ...
    { id: 'gridstorm', label: 'Grid storm', desc: 'Dark · CRT grid + lightning', category: 'dark', hidden: true,
      cos: { theme: 'dark', accent: '#c8e856', type: 'pixel', headingFont: 'pixel', tracking: 'normal', cursorStyle: 'pixel', cursorColor: '#c8e856', scanlines: true, bgPattern: 'grid', wallpaperBrightness: 48, wallpaperIntensity: 55, wallpaperUseAccent: true, wallpaper2: { enabled: true, bgPattern: 'lightning', wallpaperBrightness: 44, wallpaperIntensity: 45, wallpaperAnimSpeed: 55, wallpaperUseAccent: true }, cursorEffect: 'glow', cursorEffectIntensity: 55, glow: 110, radius: 'sharp', vibe: 'gridstorm' } },
    { id: 'phosphorgrid', label: 'Phosphor grid', desc: 'Retro · binary stream over pad grid', category: 'retro', hidden: true,
      cos: { theme: 'dark', accent: '#39ff14', type: 'pixel', headingFont: 'pixel', tracking: 'normal', cursorStyle: 'beam', cursorColor: '#39ff14', scanlines: true, bgPattern: 'binarystream', wallpaperBrightness: 50, wallpaperIntensity: 62, wallpaperAnimSpeed: 68, binaryFontSize: 72, wallpaperUseAccent: true, wallpaper2: { enabled: true, bgPattern: 'padgrid', wallpaperBrightness: 38, wallpaperIntensity: 70, wallpaperUseAccent: true }, cursorEffect: 'glow', cursorEffectIntensity: 80, glow: 125, radius: 'sharp', vibe: 'phosphorgrid' } },
    { id: 'thunderclap', label: 'Thunderclap', desc: 'Bold · intense thunderstorm', category: 'bold', hidden: true,
      cos: { theme: 'dark', accent: '#38bdf8', type: 'modern', headingFont: 'grotesk', tracking: 'normal', cursorStyle: 'halo', cursorColor: '#e0f2fe', scanlines: false, bgPattern: 'thunderstorm', rainDirection: 'down', wallpaperBrightness: 40, wallpaperIntensity: 72, wallpaperAnimSpeed: 78, wallpaperRandomness: 55, wallpaperUseAccent: true, cursorEffect: 'spark', cursorEffectIntensity: 75, vignetteIntensity: 52, vignetteDirection: 'top', glow: 140, radius: 'soft', vibe: 'thunderclap' } },
    /* —— Multi-tone —— */
    { id: 'split', label: 'Split', desc: 'Multi · teal honeycomb + coral circuits', category: 'multi-tone',
      cos: { theme: 'dark', accent: '#ff6b6b', type: 'modern', headingFont: 'grotesk', tracking: 'normal', cursorStyle: 'ring', cursorColor: '#fde047', scanlines: false, bgPattern: 'honeycomb', honeycombStyle: 'outline', wallpaperBrightness: 58, wallpaperIntensity: 60, wallpaperUseAccent: false, wallpaperColor: '#5eead4', wallpaper2: { enabled: true, bgPattern: 'circuits', wallpaperBrightness: 50, wallpaperIntensity: 68, wallpaperAnimSpeed: 58, wallpaperUseAccent: false, wallpaperColor: '#ff6b6b' }, cursorEffect: 'spark', cursorEffectIntensity: 55, glow: 110, radius: 'soft', vibe: 'split' } },
    { id: 'duotone', label: 'Duotone', desc: 'Multi · cyan fireflies + violet aurora', category: 'multi-tone',
      cos: { theme: 'dark', accent: '#c084fc', type: 'editorial', headingFont: 'editorial', tracking: 'wide', cursorStyle: 'halo', cursorColor: '#fb7185', scanlines: false, bgPattern: 'fireflies', wallpaperBrightness: 56, wallpaperIntensity: 48, wallpaperAnimSpeed: 50, cursorInteractStrength: 72, cursorParticleDensity: 42, cursorSweepRadius: 48, wallpaperUseAccent: false, wallpaperColor: '#67e8f9', wallpaper2: { enabled: true, bgPattern: 'aurora', wallpaperBrightness: 40, wallpaperIntensity: 36, wallpaperAnimSpeed: 30, wallpaperUseAccent: false, wallpaperColor: '#8b5cf6' }, cursorEffect: 'trail', cursorEffectTrailStyle: 'particles', cursorEffectTrailLength: 50, cursorEffectIntensity: 58, vignetteIntensity: 40, vignetteDirection: 'bottom', glow: 125, radius: 'round', vibe: 'duotone' } },
    /* extended: slate waves overlap sky / sunset — user-requested hide */
    { id: 'inkwave', label: 'Ink wave', desc: 'Multi · slate waves + crimson crosshatch', category: 'multi-tone', hidden: true,
      cos: { theme: 'light', accent: '#0f172a', type: 'slab', headingFont: 'slab', tracking: 'tight', cursorStyle: 'bold', cursorColor: '#e11d48', scanlines: false, bgPattern: 'waves', waveDirection: 'left', wallpaperBrightness: 52, wallpaperIntensity: 50, wallpaperAnimSpeed: 46, wallpaperUseAccent: false, wallpaperColor: '#475569', wallpaper2: { enabled: true, bgPattern: 'crosshatch', wallpaperBrightness: 36, wallpaperIntensity: 48, wallpaperUseAccent: false, wallpaperColor: '#e11d48' }, cursorEffect: 'ripple', cursorEffectIntensity: 48, cursorEffectRippleCount: 42, glow: 72, radius: 'sharp', vibe: 'inkwave' } },
    { id: 'noir', label: 'Noir', desc: 'Multi · silver glow over amber dots', category: 'multi-tone', hidden: true,
      cos: { theme: 'dark', accent: '#e2e8f0', type: 'mono', headingFont: 'mono', tracking: 'tight', cursorStyle: 'cross', cursorColor: '#fbbf24', scanlines: false, bgPattern: 'honeycombGlow', honeycombStyle: 'outline', wallpaperBrightness: 55, wallpaperIntensity: 62, wallpaperAnimSpeed: 52, wallpaperUseAccent: false, wallpaperColor: '#94a3b8', wallpaper2: { enabled: true, bgPattern: 'dots', wallpaperBrightness: 32, wallpaperIntensity: 44, wallpaperUseAccent: false, wallpaperColor: '#fbbf24' }, glow: 95, radius: 'sharp', vibe: 'noir' } },
    { id: 'coralpool', label: 'Coral pool', desc: 'Multi · teal ripples + coral dots', category: 'multi-tone',
      cos: { theme: 'dark', accent: '#f97316', type: 'modern', headingFont: 'grotesk', tracking: 'normal', cursorStyle: 'dot', cursorColor: '#a3e635', scanlines: false, bgPattern: 'ripplepool', wallpaperBrightness: 54, wallpaperIntensity: 50, wallpaperAnimSpeed: 38, cursorInteractStrength: 75, cursorTrailLength: 62, wallpaperUseAccent: false, wallpaperColor: '#22d3ee', wallpaper2: { enabled: true, bgPattern: 'dots', wallpaperBrightness: 30, wallpaperIntensity: 46, wallpaperUseAccent: false, wallpaperColor: '#f97316' }, cursorEffect: 'ripple', cursorEffectIntensity: 54, cursorEffectRippleCount: 62, vignetteIntensity: 48, vignetteDirection: 'center', glow: 115, radius: 'soft', vibe: 'coralpool' } },
    { id: 'polar', label: 'Polar', desc: 'Multi · ice aurora + ember waves', category: 'multi-tone',
      cos: { theme: 'dark', accent: '#0ea5e9', type: 'modern', headingFont: 'grotesk', tracking: 'normal', cursorStyle: 'halo', cursorColor: '#fb923c', scanlines: false, bgPattern: 'aurora', wallpaperBrightness: 58, wallpaperIntensity: 48, wallpaperAnimSpeed: 34, wallpaperUseAccent: false, wallpaperColor: '#7dd3fc', wallpaper2: { enabled: true, bgPattern: 'waves', waveDirection: 'up', wallpaperBrightness: 46, wallpaperIntensity: 40, wallpaperAnimSpeed: 36, wallpaperUseAccent: false, wallpaperColor: '#ea580c' }, cursorEffect: 'glow', cursorEffectIntensity: 58, vignetteIntensity: 42, vignetteDirection: 'bottom', glow: 118, radius: 'round', vibe: 'polar' } },
  ];
